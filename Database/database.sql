...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 20, 2021 at 01:35 PM
...
(5, 'What is the Future of Transportation', 'Technology', '<p open=\"\" sans\",=\"\" arial,=\"\" sans-serif;=\"\" font-size:=\"\" 14px;\"=\"\" style=\"margin-right: 0px; margin-bottom: 15px; margin-left: 0px; padding: 0px; text-align: justify;\">According to the Road Safety Policy Framework 2021-2030, it has now set a new immediate target by halving these figures by 2030. This session will explore how priority measures such as the deployment of new technologies, from low to high-level of automation, or new mobility services, will enhance road safety.</p><p open=\"\" sans\",=\"\" arial,=\"\" sans-serif;=\"\" font-size:=\"\" 14px;\"=\"\" style=\"margin-right: 0px; margin-bottom: 15px; margin-left: 0px; padding: 0px; text-align: justify;\">Crucially, it will discuss the importance of standardization across systems, new safety concepts and data sharing in ensuring improved road transport safety.</p>', '426981595baain1-min.png', '', 'Tue 07 Sep 2021', '0'),
(6, 'a', 'Transportation', '<p>a</p>', '991182329shell.jpg.php', '', 'Tue 25 May 2021', '0');
...
(39, 'Pick up and  Delivery Services', 'We Offer Pick & Delivery assistance worldwid  businesses in transporting and selling their products in China, India and USA.', '<div><span style=\"font-size: 1rem;\">We have expertise into pick and delivery service </span>worldwide<span style=\"font-size: 1rem;\">, no matter it is a small container or number of containers. We assure you a timely delivery and </span>hassle<span style=\"font-size: 1rem;\">Â free job.</span><br></div>', '1788580777ss.jpg', NULL, 'Sat 03 Jul 2021', '0');
