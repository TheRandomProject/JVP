                ...
                <div class="tab-pane fadeInUp animated active" id="tab-two" role="tabpanel" aria-labelledby="tab-two">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="link">-->
                                <a href="#cform" class="theme-btn btn-style-one"><span><i class="flaticon-up-arrow"></i>Click to Proceed</span></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="contact-form-section" id="cform">
        <div class="auto-container">
            <div class="sec-title text-center">
                ...
                <div class="text">Please do not hesitate to contact us if you require further information about our Batasan Super Health Center service.</div>
            </div>
            <!--Contact Form-->
