...
<div class="page-wrapper">
    ...
    <br><br><h5 class=" text-left"><b>1. Copyright and Trademark Information</b></h5>
                ...
                <p class="text-left">This website (this "Website"), and the information which it contains, such as text, graphics, images, data, reports, links, information obtained from BATASAN SUPER HEALTH CENTER, services and other medical (as defined below) contained on this Website or provided through Services (as defined below) made available on the Website (collectively, "Content") are the property of Batasan Super Health Center, its affiliates and its licensors, and are protected from unauthorized copying and dissemination by United States copyright law, trademark law, international conventions and other intellectual property laws. By way of example only, and not as a limitation, "Batasan Super Health Center" and the Batasan Super Health Center logo are registered trademarks of Batasan Super Health Center, under the applicable laws of the Quezon City and/or other countries. Other Global Worldwide Solution product or service names or logos appearing on this Website are either trademarks or registered trademarks of Global Worldwide Solution, Inc. and/or its affiliates. The absence of a product or service name or logo from this list does not constitute a waiver of Global Worldwide Solution's trademark or other intellectual property rights concerning that name or logo.</p>
